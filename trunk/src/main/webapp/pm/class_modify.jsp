        ...
        <tr>
          <td width="1024" height="542" valign="top"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
			  ...
			  <form name="" method="post" action="${pageContext.request.contextPath}/pm_class_modify.do">
			  <table width="95%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td><div align="left" class="pagenav1">后台管理　－＞ 班级管理 －＞ 修改班级 </div></td>
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle">&nbsp;如：192.168.1</td>
                      </tr>
                      <tr>
