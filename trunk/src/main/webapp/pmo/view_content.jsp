		...
		<script>
			...
			function checkcb(){
				...
				for(var i=0; i<a.length; i++)
				{
					...
					{ 
						if(tmpStr.substring(0,1)=="c"){
							alert("授课实施问题'"+tmpStr.substring(1,2)+"'没有选择");
						}else{
							alert("学习管理问题'"+tmpStr.substring(1,2)+"'没有选择");
						}
						return false;
					}
				}
				if(!isEmpty1(document.form1.q1,1,512,"对班级管理的合理化建议没有填写","班级管理的合理化建议 字数已超过最大限制")){
					return false;
				}
				if(!isEmpty1(document.form1.q2,1,512,"对老师授课过程的建议没有填写","老师授课过程的建议 字数已超过最大限制")){
					return false;
				}
			}
		/*  $(function(){
														...
														<td width="100%" height="170" valign="top" align="center">
																<table width="95%" border="0" cellpadding="0"
																	...
																	<!-- 第一部份迭代完成 -->
																		...
																		<tr>
																			<td colspan="7">
																				<textarea name="a1" rows="4" cols="120" class="txtarea_style" onfocus="javaScript:if(this.value=='这家伙很懒，什么也没留下') {this.value='';}" onblur="javaScript:if(this.value == '') {this.value = '这家伙很懒，什么也没留下';}">这家伙很懒，什么也没留下</textarea>
																			</td>
																		</tr>
																		<tr>
																			<td colspan="7">&nbsp;</td>
