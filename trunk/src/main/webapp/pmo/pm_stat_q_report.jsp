							...
							<td width="1024" height="439" valign="top">
								...
								<tr>
										...
										<td align="center" valign="top">
											<form name="statistics_form" method="post" action="${pageContext.request.contextPath}/pmo_poll_query_q.do">
												<table width="100%" height="207" border="0" cellpadding="0"
													cellspacing="0">
													
													<tr>
														<td height="46" align="center">
															<fieldset><legend>季报表查询</legend>
																<table width="100%" height="27" border="0">
																	<tbody align="center">
																		<tr>
																			...
																			<td width="6%">
																				<select name="quarter">
																					<option value="1" ${quarter=='1'?'selected':''}>
																						01
																					</option>
																					<option value="2" ${quarter=='2'?'selected':''}>
																						02
																					</option>
																					<option value="3" ${quarter=='3'?'selected':''}>
																						03
																					</option>
																					<option value="4" ${quarter=='4'?'selected':''}>
																						04
																					</option>
																				</select>
																			</td>
													...
													<tr>
														<td height="19" align="center">
																...
																<span class="FontBlack">第</span><FONT color=#ff0000><B>${quarter }</B>
																</FONT><span class="FontBlack">季度</span>统计表 
														</td>
													</tr>
													<c:if test="${empty groupByPM}" var="isexit">
													<tr>
														<td height="19" colspan="7" align="center" class="odd"><font color="#FF0000">${year}年&nbsp;${quarter}季度没有相关课程调查统计信息</font></td>
													</tr>
													</c:if>
													<c:if test="${!isexit}">
														...
														<td height="118">
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																...
																<tr>
																	...
																	<td align="right">季平均分：<fmt:formatNumber value="${avg}" pattern="#.0" type="number" /></td>
																</tr>
															</table>
															<hr />
														</td>
