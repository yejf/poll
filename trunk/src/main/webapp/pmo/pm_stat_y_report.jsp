							...
							<td width="1024" height="439" valign="top">
								...
								<tr>
										...
										<td align="center" valign="top">
											<form name="statistics_form" method="post" action="${pageContext.request.contextPath}/pmo_poll_query_y.do">
												<table width="100%" height="207" border="0" cellpadding="0"
													cellspacing="0">
													
													<tr>
														<td height="46" align="center">
															<fieldset><legend>年报表查询</legend>
																		...
																		<tr>
																			...
																			<td width="7%">
																				<select name="year">
																					...
																					<option value="2009" ${year=='2015'?'selected':''}>
																						2015
																					</option>
																					<option value="2010" ${year=='2016'?'selected':''}>
																						2016
																					</option>
																				</select>
																			</td>
													...
													<tr>
														<td height="19" colspan="7" align="center" class="odd"><font color="#FF0000">${year}年没有相关课程调查统计信息</font></td>
													</tr>
													</c:if>
													<c:if test="${!isexit}">
														...
														<td height="118">
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																...
																<tr>
																	...
																	<td align="right">年平均分：<fmt:formatNumber value="${avg}" pattern="#.0" type="number" /></td>
																</tr>
															</table>
															<hr />
														</td>
