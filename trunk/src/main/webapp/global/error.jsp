              ...
              <td width="1024" valign="top"><table width="100%" height="86%" border="0" align="center" cellpadding="0" cellspacing="0" >
                  ...
                  <tr>
					...
					<tr>
					  <td>
					  <fieldset>
					  <legend><font color="#FF0000">× 系统错误</font></legend>
					  	<table width="100%">
								<tr>
									<td width="100%" align="center">${message}
									<c:if test="${currentUser.type==1}">
										<a href="${pageContext.request.contextPath}/pmo_poll_to_query.do">已审调查</a>
									</c:if>
									</td>
								</tr>
								<tr>
								...
								<tr align="center">
									<td><input type="submit" onclick="javascript:closeWin();" value="关闭窗口"></input></td>
								</tr>
						</table>
					  </fieldset>
					  </td>
